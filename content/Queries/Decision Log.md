...
Use this page for planning decisions that should not disappear into chat history.

| Date Decided | Decision | Reason | Impact | Related Pages |
| --- | --- | --- | --- | --- |
| 2026-05-15 | Use this vault as the Finland roadtrip planning wiki. | The copied template needed trip-specific structure. | Added research, logistics, concepts, entities, and query pages. | [[Trip Overview]], [[Country/_Index|Country]], [[Routes/_Index|Routes]], [[Ferries/_Index|Ferries]], [[Lodging/_Index|Lodging]] |
| 2026-05-15 | Keep the trip spontaneous rather than maintaining a daily itinerary. | The planning goal is to gather information first: country, routes, ferries, lodging, history, and natural history. | Removed daily itinerary pages and reorganized around research sections. | [[Country/_Index|Country]], [[Routes/_Index|Routes]], [[Ferries/_Index|Ferries]], [[Lodging/_Index|Lodging]] |
...
- Must-see themes.
- Driving pace.
- Exact festival house checkout date.
- Kayaking and remote island feasibility.
