...
This vault is the research and planning wiki for the Finland roadtrip from Thursday 2026-06-04 through Friday 2026-06-26.

## Start Here

- Review [[Trip Overview]]
- Review [[Country/_Index|Country]]
- Review [[Routes/_Index|Routes]]
- Review [[Ferries/_Index|Ferries]]
- Review [[Lodging/_Index|Lodging]]
- Review [[Logistics/_Index|Logistics]]
- Review [[Queries/Open Planning Questions]]
- Review [[Sources/_Index|Sources]]
- Review [[Concepts/_Index|Concepts]]
- Review [[Entities/_Index|Entities]]
- Review [[Queries/_Index|Queries]]
- Check [[Logs/Change Log]]

## Current Status

- Trip dates are known: 2026-06-04 to 2026-06-26 in Finland, arriving by plane to Helsinki.
- The roadtrip starts and ends in Helsinki. The rental car is planned for 2026-06-06 through 2026-06-25, with pickup at Helsinki Airport.
- Helsinki is the carless city base at the beginning and end of the trip.
...
- Official festival details are now ingested in [[Sources/Solstice Festival Official Details]]; next route planning should treat Ruka as a concrete northern anchor rather than a vague event placeholder.

## Current Workflow

1. Capture new facts in the relevant research page first: country, route, ferry, lodging, logistics, entity, source note, or query.
2. Put original files and clipped sources in `raw/`, then ask Codex to ingest them into [[Sources/_Index|Sources]].
3. Use [[Queries/Open Planning Questions]] to drive the next planning session.
4. Keep booking commitments in [[Logistics/Booking Tracker]] and unresolved decisions in [[Queries/Decision Log]].
5. Update [[Logs/Change Log]] when the vault structure or confirmed plan changes.
