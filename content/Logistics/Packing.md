...
- Rain gear:
- Hiking shoes:
- Festival shoes for uneven fell terrain:
- Swim / sauna:
- Sleepwear:
...
- Cooler / food box:
- Water bottles:
- Empty non-deposit festival water bottle:
- First aid:
- Trash bags:
- Camp setup: in scope; expected to be borrowed from a local friend, with completeness still to verify.
- Hut setup: in scope if trail huts or cabin-hut stays are selected.
...
- Which borrowed camping items are available locally, and which still need to be packed or bought?
- Are cabins, camping, hotels, huts, or mixed stays planned for each route segment?
