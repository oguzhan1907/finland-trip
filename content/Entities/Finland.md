...
Finland is the primary destination for the June 2026 roadtrip. This page should collect country-level planning constraints, linked places, route decisions, and official source notes once they are ingested.

The first ingested route sources make Finland appear as a set of route families rather than a single route: archipelago/coast, Saimaa/Lakeland, South Coast culture and design, West Coast maritime towns, and North Lapland. These are still planning candidates, not commitments.

The first Luontoon source adds a practical public-access layer: [[Concepts/Everyman's Rights In Finland]] can make spontaneous low-impact nature use feasible, but protected-area, campfire, fishing, dog, privacy, land-use, and vehicle limits remain operational constraints.
...
- Which regions of Finland are in scope?
